...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        with col3:
            st.image("assets/login.png", width=100)
        with col4:
            username = st.text_input("Nom d'utilisateur")
        
        col5, col6 = st.columns([1, 10])
        with col5:
            st.image("assets/mdp.png", width=100)
        with col6:
        ...
        if option == "Ajouter un nouveau abonné":
            ...
            with col1:
                st.image("assets/id-card.png", width=100)
            with col2:
        ...
        if option == "Liste des abonnés":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/liste.png", width=100)
            with col2:
        ...
        if option == "Saisir une consommation":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/saisie.png", width=100)
            with col2:
        ...
        if option == "Paiement d'abonnement":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/pay.png", width=100)
            with col2:
        ...
        if option == "Paiement de consommation":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/pay2.png", width=100)
            with col2:
        ...
        if option == "Historique consommation & Paiment":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/historique.png", width=100)
            with col2:
        ...
        if option == "Stock":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/warehouse.png", width=100)
            with col2:
            ...
            if option == "Produit Acheter":
                ...
                col1, col2 = st.columns([1, 10])
                with col1:
                    st.image("assets/vue_stock.png", width=100)
                with col2:
        ...
        if option == "ONEP":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/budget.png", width=100)
            with col2:
        ...
        '''
            ...
            if option == "Payer ONEP":
                col1, col2 = st.columns([1, 10])
                with col1:
                    st.image("assets/pay3.png", width=100)
                with col2:
                ...
                col1, col2 = st.columns([1, 10])
                with col1:
                    st.image("assets/debt.png", width=100)
                with col2:
        ...
        if option == "Charge Maintenance":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/mechanic.png", width=100)
            with col2:
            ...
            col1, col2 = st.columns([1, 15])
            with col1:
                st.image("assets/money.png", width=100)
            with col2:
            ...
            col1, col2 = st.columns([1, 15])
            with col1:
                st.image("assets/materiel.png", width=100)
            with col2:    
        ...
        if option == "Générer une facture de paiement":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/facture.png", width=100)
            with col2:
        ...
        if option == "Mouvement de la caisse":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/caisse.png", width=100)
            with col2:
        ...
        if option == "Vérification Consommation":
            col1, col2 = st.columns([1, 10])
            with col1:
                st.image("assets/verification.png", width=100)
            with col2:
